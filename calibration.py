...
def main(argv):
    ...
    parser.add_argument('--marker-id', default=0, type=int, help="ID of the ARTag marker in the image")
    ...
    if os.path.exists(args.datafile) and not args.overwrite:
        ...
        # import pickle
        # pickle.dump({'pos': xyz_points, 'quat': orient_points}, open('caldata_raw.pkl', 'wb'))
        # sys.exit(0)
